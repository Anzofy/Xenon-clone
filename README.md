...
```bash
git clone https://github.com/Anzofy/Xenon-clone.git
cd Xenon-clone
```
...
[Sunday X Development](https://discord.gg/cyTW9Zbker)
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/Anzofy/Xenon-clone/blob/main/LICENSE) file for details.

## Author

- **</> A n z o aka anzo.fy** - *Initial work* - [Sunday X Development](https://discord.gg/cyTW9Zbker)

## Acknowledgments

- Thanks to the Discord.js team for their amazing library
- Special thanks to the Sunday X Development

## Copyright

Copyright (c) 2025 Sunday X Development. All rights reserved. 
